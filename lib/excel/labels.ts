...
export async function getSheetLabels(): Promise<SheetLabels> {
  ...
  return {
    ...
    colOrder: tExcel("colOrder"),
    colRecipient: tExcel("colRecipient"),
    colDevices: tExcel("colDevices"),
    sheetDevices: tExcel("sheetDevices"),
    colPaid: tExcel("colPaid"),
    colDeviceCount: tExcel("colDeviceCount"),
    manyDevices: (count: number) => tExcel("manyDevices", { count }),
    colMonth: tExcel("colMonth"),
    colCount: tExcel("colCount"),
    valueYes: tExcel("valueYes"),
    valueNo: tExcel("valueNo"),
